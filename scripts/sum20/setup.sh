...
sudo apt install i3 git jq build-essential neovim curl bash-completion pigz p7zip-full net-tools flatpak zsh tmux rofi chromium-browser mpv vlc node-js bat exa libdbus-1-dev pkg-config libssl-dev feh exiftool imagemagick gnome-tweaks -y
